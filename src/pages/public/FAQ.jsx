...
const FAQS = [
  ...
  { q: 'How does the Premium subscription work?', a: 'Premium is $9.99/month, or $89.88/year billed annually (saving $30.00). It unlocks AI-powered analysis, full 365-day history, trend insights, and shareable PDF reports. You can cancel anytime — no lock-in.' },
  ...
  { q: 'When will GlowMouth be available in my country?', a: 'GlowMouth is launching first in the United States and Canada, with the sensor shipping directly to customers. The app is available everywhere, including markets without sensor shipping yet. Join the waitlist for updates as new regions open.' },
  { q: 'What happens to my data if I cancel my subscription?', a: 'Your scan history and account data remain stored and accessible on the Free plan after you cancel Premium — you simply lose access to AI interpretation, full 365-day history, and dentist reports. You can export all of your data at any time from Settings, and permanently delete your account and all associated data whenever you choose.' },
];
            ...
            {FAQS.map((faq, i) => (
              <div key={i} className="faq-item">
                <button className="faq-question" onClick={() => setOpen(open === i ? null : i)} aria-expanded={open === i}>
                  {faq.q}
                  <span className="faq-icon" aria-hidden style={{ transform: open === i ? 'rotate(45deg)' : 'none' }}>+</span>
                </button>
